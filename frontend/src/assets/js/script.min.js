$(document).ready(function () {
    ...
    e("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
        ...
        if (e(window).width() > 768) {
            var t = o.originalEvent, a = t.wheelDelta || -t.detail;
            this.scrollTop += 30 * (a < 0 ? 1 : -1), o.preventDefault()
        }
    }), e(document).on("scroll", function () {
        e(this).scrollTop() > 100 ? e(".scroll-to-top").fadeIn() : e(".scroll-to-top").fadeOut()
    }), e(document).on("click", "a.scroll-to-top", function (o) {
        var t = e(this);
        e("html, body").stop().animate({scrollTop: e(t.attr("href")).offset().top}, 1e3, "easeInOutExpo"), o.preventDefault()
    })
}(jQuery);