<template>
  <div style="height: 90vh;width: 100%">
    <div id='myWeekdayLinePlot' style="height: inherit"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    async fetchData() {
      var reqUrl = 'http://127.0.0.1:5000/DayDataValues' //无参的例子
    ...
    drawLinePlot() {
      ...
      var data = [trace1];
      var layout = {
        title: 'Count of Accidents by Weekday',
        xaxis: {
          title: 'Weekday'
        },
        yaxis: {
      ...
      Plotly.newPlot('myWeekdayLinePlot', data, layout, config);
    }
  }
}
</script>
